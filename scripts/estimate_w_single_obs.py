...
from src.utils import define_default_folders_scoring_rules, dict_implemented_scoring_rules, estimate_bandwidth, \
...
if method == "KernelScore":
    ...
    start = time()
    SR_kwargs["sigma"] = estimate_bandwidth(model_abc, backend, seed=seed + 1, n_theta=n_theta,
